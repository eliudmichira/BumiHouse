  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-emerald-100 to-emerald-50 dark:from-[#0a0c19] dark:via-[#0e1320] dark:to-[#0a0c19]">
      ...
      <section ref={heroRef} className="relative overflow-hidden min-h-[calc(100vh-80px)] pt-32 pb-16 flex items-center">
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/10 via-teal-500/10 to-[#06b6d4]/15"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className={`text-center transition-all duration-1000 ${
            ...
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-full border border-white/20 dark:border-gray-700/20 mb-8">
              ...
              <span className="text-sm font-semibold bg-gradient-to-r from-emerald-500 to-[#06b6d4] bg-clip-text text-transparent">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-8">
              ...
              <br />
              <span className="bg-gradient-to-r from-emerald-500 via-teal-500 to-[#06b6d4] bg-clip-text text-transparent">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
              <button 
                ...
                className="group px-8 py-4 bg-gradient-to-r from-emerald-500 to-[#06b6d4] text-[#111] font-semibold rounded-2xl hover:shadow-2xl hover:shadow-emerald-500/25 transform hover:scale-105 transition-all duration-300 flex items-center gap-3"
              >
                ...
                {[
                  ...
                  >
                    <div className="relative rounded-2xl p-6 bg-white/70 dark:bg-gray-800/60 border border-white/20 dark:border-gray-700/30 backdrop-blur-xl">
                      <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-[#06b6d4]/10"></div>
                      <div className="relative flex flex-col items-center">
                        <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-r from-emerald-500 to-[#06b6d4] mb-3">
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        ...
        <section id="security" className={`${activeSection === 'security' ? 'block' : 'hidden'}`}>
          <div className="text-center mb-16">
            <div className="w-20 h-20 bg-gradient-to-r from-emerald-500 to-[#06b6d4] rounded-full flex items-center justify-center mx-auto mb-8">
          ...
          <div className="grid lg:grid-cols-2 gap-16 mb-16">
            <div className="space-y-8">
              {[
                ...
                <div key={index} className="flex items-start gap-6 group">
                  <div className={`w-16 h-16 bg-gradient-to-r from-emerald-500 to-[#06b6d4] rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}>
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-[#06b6d4] rounded-3xl blur-xl opacity-20"></div>
        ...
        <section id="technology" ref={featuresRef} className={`${activeSection === 'technology' ? 'block' : 'hidden'}`}>
            ...
            {[
              ...
              >
                <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-white/20 dark:border-gray-700/20 hover:-translate-y-2">
                  ...
                  <div className={`w-16 h-16 bg-gradient-to-r from-emerald-500 to-[#06b6d4] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
          ...
          <div className="bg-gradient-to-r from-emerald-500 to-[#06b6d4] rounded-3xl p-12 text-[#111]">
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 via-teal-500 to-[#06b6d4]"></div>
