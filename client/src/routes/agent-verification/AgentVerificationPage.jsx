...
const AgentVerificationPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#3b82f6]/10 to-[#06b6d4]/10 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between mb-6">
            ...
            >
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#3b82f6] to-[#4fd69c] p-0.5">
                <img 
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className={`p-8 rounded-2xl ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-lg`}>
              <div className="text-center mb-8">
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#3b82f6] to-[#06b6d4] flex items-center justify-center mx-auto mb-4">
                ...
                {verificationStatus === 'pending' ? (
                  ...
                  <button
                    ...
                    className="px-8 py-4 bg-gradient-to-r from-[#3b82f6] to-[#06b6d4] text-[#111] rounded-xl font-semibold hover:shadow-lg transition-all"
                  >
            ...
            <div className={`p-6 rounded-2xl ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-lg`}>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#3b82f6] text-[#111] flex items-center justify-center text-sm font-bold">
                    1
                  </div>
                  <div>
