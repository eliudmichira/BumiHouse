        ...
        <div className="space-y-6">
            <div className={`p-5 rounded-2xl ${isDark ? 'bg-[#10121e]' : 'bg-white shadow-sm'}`}>
                <h2 className={`text-xl font-bold mb-6 flex items-center gap-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>
                    <Building2 className="w-6 h-6 text-[#3b82f6]" /> Basic Details
                </h2>
                ...
                <div className="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full p-4 rounded-xl border font-medium ${isDark ? 'bg-[#1a1d2d] border-gray-700 text-white placeholder-gray-600' : 'bg-gray-50 border-gray-200 text-gray-900 placeholder-gray-400'} focus:ring-2 focus:ring-[#3b82f6] outline-none transition-all`}
                        />
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {propertyTypes.map((type) => {
                                ...
                                return (
                                    ...
                                    >
                                        <Icon className={`w-8 h-8 mb-2 ${isSelected ? 'text-[#3b82f6]' : 'text-gray-400'}`} />
                                        <span className={`font-medium ${isSelected ? 'text-[#3b82f6]' : isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                                            {type.label}
                                        </span>
                                    </button>
                                );
                    ...
                    {(formData.propertyType === 'apartment' || formData.propertyType === 'commercial') && (
                        <div className={`p-4 rounded-xl border flex items-center justify-between transition-all ${formData.hasMultipleUnits
                            ...
                            <div className="flex items-center gap-3">
                                <Building2 className={`w-5 h-5 ${formData.hasMultipleUnits ? 'text-[#3b82f6]' : 'text-gray-400'}`} />
                                <div>
                            ...
                            {['for-sale', 'for-rent'].map((status) => (
                                <button
                                    ...
                                    className={`p-3 rounded-xl border-2 font-bold uppercase tracking-wide transition-all ${formData.status === status
                                        ? 'border-[#3b82f6] bg-[#3b82f6] text-[#0a0c19]'
                                        : isDark
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="0.00"
                                    className={`w-full p-4 pl-12 rounded-xl border font-mono text-lg ${isDark ? 'bg-[#1a1d2d] border-gray-700 text-white' : 'bg-gray-50 border-gray-200 text-gray-900'} focus:ring-2 focus:ring-[#3b82f6] outline-none`}
                                />
                            </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className={`w-full p-4 rounded-xl border ${isDark ? 'bg-[#1a1d2d] border-gray-700 text-white placeholder-gray-600' : 'bg-gray-50 border-gray-200 text-gray-900 placeholder-gray-400'} focus:ring-2 focus:ring-[#3b82f6] outline-none resize-none`}
                        />
